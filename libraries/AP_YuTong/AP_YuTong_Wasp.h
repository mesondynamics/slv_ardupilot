...
class AP_YuTong_Wasp : public AP_YuTong_Backend_Serial {

public:

    static AP_YuTong_Backend_Serial *create(
        YuTong::YuTong_State &_state,
        AP_YuTong_Params &_params) {
        return NEW_NOTHROW AP_YuTong_Wasp(_state, _params);
    }
...
private:
    ...
    AP_YuTong_Wasp(YuTong::YuTong_State &_state,
                        AP_YuTong_Params &_params);
