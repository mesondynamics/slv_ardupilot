...
// Data timeout
#define AP_YUTONG_MAVLINK_TIMEOUT_MS 500

class AP_YuTong_MAVLink : public AP_YuTong_Backend
{
...
public:
    ...
    // Assume that if the user set the YUTONG_TYPE parameter to MAVLink,
    // there is an attached MAVLink yutong
