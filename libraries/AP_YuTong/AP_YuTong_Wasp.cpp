...
const AP_Param::GroupInfo AP_YuTong_Wasp::var_info[] = {
    // @Param: WSP_MAVG
    ...
    // @Range: 0 255
    // @User: Advanced
    AP_GROUPINFO("WSP_MAVG", 1, AP_YuTong_Wasp, mavg, 4),
    ...
    // @Range: 0 255
    // @User: Advanced
    AP_GROUPINFO("WSP_MEDF", 2, AP_YuTong_Wasp, medf, 4),
    ...
    // @Range: 0 10000
    // @User: Advanced
    AP_GROUPINFO("WSP_FRQ", 3, AP_YuTong_Wasp, frq, 20),
    ...
    // @Range: 0 255
    // @User: Advanced
    AP_GROUPINFO("WSP_AVG", 4, AP_YuTong_Wasp, avg, 2),
    ...
    // @Range: -1 255
    // @User: Advanced
    AP_GROUPINFO("WSP_THR", 5, AP_YuTong_Wasp, thr, -1),
    ...
    // @User: Advanced
    AP_GROUPINFO("WSP_BAUD", 6, AP_YuTong_Wasp, baud, 0),

    AP_GROUPEND
};

AP_YuTong_Wasp::AP_YuTong_Wasp(YuTong::YuTong_State &_state,
                                         AP_YuTong_Params &_params) :
    AP_YuTong_Backend_Serial(_state, _params)
{
...
bool AP_YuTong_Wasp::get_reading(float &reading_m) {
    if (uart == nullptr) {
        return false;
    }
...
void AP_YuTong_Wasp::update(void) {
...
void AP_YuTong_Wasp::parse_response(void) {
    switch (configuration_state) {
        case WASP_CFG_RATE:
            configuration_state = WASP_CFG_ENCODING;
            break;
